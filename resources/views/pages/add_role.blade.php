                            ...
                            <div class="item-decentra">
                                ...
                                <ul>
                                    <li class="li-item-decentra">
                                        <input type="checkbox" name="role[]" value="all">
                                        Tất cả
                                    </li>
                                    <li class="li-item-decentra"><input type="checkbox" name="role[]" value="x"
                                           >
                                        Chức năng x</li>
                                    <li class="li-item-decentra"><input type="checkbox" name="role[]" value="y"
                                            >
                                        Chức năng y</li>
                                    <li class="li-item-decentra"><input type="checkbox" name="role[]" value="z"
                                            >
                                        Chức năng z</li>
                                </ul>
                            </div>

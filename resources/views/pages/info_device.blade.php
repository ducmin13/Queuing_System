...
<main>
    ...
    <div class="content-add-device">
        ...
        <div class="area-form-add-device">
            <a href="/device/fupdate/{{$value->id}}">
            ...
            <div class="info-device">
                <div class="item-info-device">
                    <div class="text-info-device">
                        <p>Mã thiết bị: </p><span>{{$value->device_id}}</span>
                    </div>
                    <div class="text-info-device">
                        <p>Tên thiết bị: </p><span>{{$value->device_name}}</span>
                    </div>
                    <div class="text-info-device">
                        <p>Địa chỉ IP: </p><span>{{$value->ip_address}}</span>
                    </div>
                </div>
                <div class="item-info-device">
                    <div class="text-info-device">
                        <p>Loại thiết bị: </p><span>{{$value->device_type}}</span>
                    </div>
                    <div class="text-info-device">
                        <p>Tên đăng nhập: </p><span>{{$value->username}}</span>
                    </div>
                    <div class="text-info-device">
                        <p>Mật khẩu: </p><span>{{$value->password}}</span>
                    </div>
                </div>
            </div>

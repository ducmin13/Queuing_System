        ...
        <div class="area-form-add-device">
            ...
            <form id="form-update-device" class="form-add-device"
                ...
                <div class="item-form-add-device">
                    ...
                    <input name="device_name" type="text" placeholder="" value="{{ $value ->device_name }}">
                </div>
                ...
                <div class="item-form-add-device">
                    ...
                    <input name="ip_address" type="text" placeholder="" value="{{ $value ->ip_address }}">
                </div>
                ...
                <div class="item-form-add-device">
                    ...
                    <input class="input-user-device" name="service" type="text" value="{{ $value ->service }}">
                </div>

...
<header>
    <nav class="navbar navbar-expand-md navbar-light bg-light">
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a style="color: #FF9138;" class="nav-link title" href="#">Dashboard</a>
                </li>
...
<div class="sidebar-container">
            ...
            <a href="dashboard">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        ...
                        stroke="#A9A9B0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    <path
                        ...
                        stroke="#A9A9B0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    <path
                        d="M8.74996 10.916V16.5827C8.74996 17.8327 8.21663 18.3327 6.89163 18.3327H3.52496C2.19996 18.3327 1.66663 17.8327 1.66663 16.5827V10.916C1.66663 9.66602 2.19996 9.16602 3.52496 9.16602H6.89163C8.21663 9.16602 8.74996 9.66602 8.74996 10.916Z"
                        stroke="#A9A9B0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    <path
                        d="M8.74996 3.41602V4.91602C8.74996 6.16602 8.21663 6.66602 6.89163 6.66602H3.52496C2.19996 6.66602 1.66663 6.16602 1.66663 4.91602V3.41602C1.66663 2.16602 2.19996 1.66602 3.52496 1.66602H6.89163C8.21663 1.66602 8.74996 2.16602 8.74996 3.41602Z"
                        stroke="#A9A9B0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
                <p>Dashboard</p>
            </a>
            ...
            <a href="device">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        ...
                        stroke="#A9A9B0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M10 14.3496V18.3329" stroke="#A9A9B0" stroke-width="1.5" stroke-linecap="round"
                        stroke-linejoin="round" />
                    <path d="M1.6665 10.834H18.3332" stroke="#A9A9B0" stroke-width="1.5" stroke-linecap="round"
                        stroke-linejoin="round" />
                    <path d="M6.25 18.334H13.75" stroke="#A9A9B0" stroke-width="1.5" stroke-linecap="round"
                        stroke-linejoin="round" />
                </svg>
                <p>Thiết bị</p>
            </a>
        ...
        <li class="menu-item">
            <a href="service">
                <svg width="22" height="20" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g clip-path="url(#clip0_69430_3744)">
                        <path
                    ...
                    <path
                        ...
                        stroke="#A9A9B0" stroke-width="1.5" stroke-miterlimit="10" />
                    <path
                        ...
                        stroke="#A9A9B0" stroke-width="1.5" stroke-miterlimit="10" />
                    <defs>
                        <clipPath id="clip0_69430_3744">
                            <rect width="3.54138" height="5.66621" fill="white"
                ...
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_69430_3758)">
                        <g clip-path="url(#clip1_69430_3758)">
                            <path d="M1.6665 14.166L9.99984 18.3327L18.3332 14.166" stroke="#A9A9B0"
                                stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M1.6665 10L9.99984 14.1667L18.3332 10" stroke="#A9A9B0" stroke-width="1.66667"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M9.99984 1.66602L1.6665 5.83268L9.99984 9.99935L18.3332 5.83268L9.99984 1.66602Z"
                                stroke="#A9A9B0" stroke-width="1.66667" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </g>
                    </g>
                    <defs>
                        <clipPath id="clip0_69430_3758">
                            <rect width="20" height="20" fill="white" />
                        </clipPath>
                        <clipPath id="clip1_69430_3758">
                            <rect width="20" height="20" fill="white" />
                        </clipPath>
                    </defs>
                </svg>
    ...
    <div class="button-container">
        <a href="logout"><button type="submit" class="button">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M13.3335 14.1673L17.5002 10.0007L13.3335 5.83398" stroke="#FF7506" stroke-width="2"
                        stroke-linecap="round" stroke-linejoin="round" />
